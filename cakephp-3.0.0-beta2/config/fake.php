...
$config = [
    ...
    'App' => [
        'namespace' => 'App',
        'envImgUrl' => 'http://dev.ornythorink.net/webroot/img/',
        'envJsUrl' => 'http://dev.ornythorink.net/webroot/js/',
        'imgCachePath' => '/htdocs/dev/tmp/cache/images/',
        'imgCacheUri' => 'http://dev.ornythorink.net/tmp/cache/images/',
        'webservice' => 'vroum.ornythorink.net',
        'dirWS' => '/www',
        'encoding' => 'UTF-8',
        'base' => false,
        'dir' => 'src',
     ...
     */
    'Security' => [
        'salt' => 'ec3e65cf23cfe7374eabd3628537b1c639a4023b281714bc8fb2721563c34995',
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'password' => 'boheme144$',
            'database' => 'ornythorink_lingerie_fake',
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
